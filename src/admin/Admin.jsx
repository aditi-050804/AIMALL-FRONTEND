...
const Admin = () => {
    ...
    useEffect(() => {
        ...
        } else if (location.pathname.includes('admin') && activeTab === 'settings') {
            // Only switch back to overview if we were in settings and moved to admin root
    ...
    return (
        <div className="h-screen flex bg-transparent overflow-hidden">
            ...
            {/* Mobile Overlay */}
            {isMobileSidebarOpen && !location.pathname.includes('settings') && (
                <div
